...
function ModalDetalle({card,colKey,colStyles,colKeys,onClose,onMove,onComment,onArchive,onRestore,onUpdateResponsables,onAdjuntarArchivo,onEditarPedido,perfil,usuarios=[],grupos=[],esArchivado=false,headerColor='#3a9e3f'}) {
  ...
  return (
    <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.5)',display:'flex',alignItems:isMobile?'flex-end':'flex-start',justifyContent:'center',padding:isMobile?0:'20px 16px',zIndex:100,overflowY:'auto'}} onClick={e=>{if(e.target===e.currentTarget)onClose()}}>
      <div style={{background:'#fff',borderRadius:isMobile?'14px 14px 0 0':14,width:'100%',maxWidth:isMobile?'100%':540,overflow:'hidden',boxShadow:'0 20px 60px rgba(0,0,0,0.28)',maxHeight:isMobile?'92vh':'80vh',overflowY:'auto',maxHeight:'92vh',overflowY:'auto'}}>
...
function ModalNuevo({onClose,onCreate,headerColor='#3a9e3f',usuarios=[],grupos=[]}) {
  ...
  return (
    <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.5)',display:'flex',alignItems:isMobile?'flex-end':'center',justifyContent:'center',zIndex:200,padding:isMobile?0:'20px 16px'}} onClick={e=>{if(e.target===e.currentTarget)onClose()}}>
      <div style={{background:'#fff',borderRadius:isMobile?'14px 14px 0 0':14,width:'100%',maxWidth:isMobile?'100%':460,overflow:'hidden',boxShadow:'0 20px 60px rgba(0,0,0,0.28)'}}>
...
function Archivo({archivados,onBack,onOpenCard,headerColor='#3a9e3f'}) {
  ...
  return (
    <div style={{minHeight:'100vh',background:'#f0f0ec',overflowX:'hidden',width:'100%'}}>
